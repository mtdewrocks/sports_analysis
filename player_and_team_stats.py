...
os.chdir(r'r"https://github.com/mtdewrocks/sports_analysis/tree/main/data')
week = 18
...
output_path = r"https://github.com/mtdewrocks/sports_analysis/tree/main/data/Player_Stats_Weekly.xlsx"
